...
PEND_ZOOM_MOVE                              =   [0,0]
ENERGY_BAR_GENERATION_TIMER                 =   0
ENERGY_BAR_GENERATION_TIMER_LIMIT          =   2
...
while not EXIT:
    ...
    engine.generateEnergyChargeParticles(PLAYER, PARTICLES, DASH_TIMER_LIMIT, ENERGY_BAR_GENERATION_TIMER, ENERGY_BAR_GENERATION_TIMER_LIMIT)
